...
function useContractFunction(contract, functionName, options) {
    ...
    var _d = (0, src_1.useConfig)().bufferGasLimitPercentage, bufferGasLimitPercentage = _d === void 0 ? 0 : _d;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, usePromiseTransaction_1.estimateGasLimit)(opts, library === null || library === void 0 ? void 0 : library.getSigner(), bufferGasLimitPercentage)];
                    case 1:
                        gasLimit = _c.sent();
