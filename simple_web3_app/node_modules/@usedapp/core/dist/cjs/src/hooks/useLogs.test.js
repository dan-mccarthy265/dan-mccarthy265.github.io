...
describe('useLogs', function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    ...
                    (0, chai_1.expect)((0, utils_1.getAddress)(log1.data['from'])).to.equal((0, utils_1.getAddress)(constants_1.AddressZero), 'From');
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    ...
                    (0, chai_1.expect)((_e = (_d = result.current) === null || _d === void 0 ? void 0 : _d.value) === null || _e === void 0 ? void 0 : _e.length).to.equal(1, 'Number of logs');
                    log = result.current.value[0];
                    (0, chai_1.expect)((0, utils_1.getAddress)(log.data['from'])).to.equal((0, utils_1.getAddress)(constants_1.AddressZero), 'From');
    ...
    it('Can query mint transfer logs by sender', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                return [4 /*yield*/, sendToken(deployer, receiver.address, ethers_1.BigNumber.from(1))];
                case 1:
                    // Send to emit another Transfer token that our filter should filter out
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.renderWeb3Hook)(function () {
    ...
    it('Can query by block hash', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, sendToken(deployer, receiver.address, ethers_1.BigNumber.from(1))];
                case 1:
                ...
                case 3:
                    ...
                    (0, chai_1.expect)(log.data['value']).to.equal(ethers_1.BigNumber.from(1), 'Amount');
