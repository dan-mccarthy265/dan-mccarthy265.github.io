...
exports.usePromiseTransaction = exports.estimateGasLimit = void 0;
 ...
 * @internal
 */
function estimateGasLimit(transactionRequest, signer, bufferGasLimitPercentage) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!transactionRequest.gasLimit) return [3 /*break*/, 1];
                    _a = ethers_1.BigNumber.from(transactionRequest.gasLimit);
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, signer.estimateGas(transactionRequest)];
                case 2:
                    _a = _b.sent();
                    _b.label = 3;
                case 3:
                    estimatedGas = _a;
                    return [2 /*return*/, estimatedGas === null || estimatedGas === void 0 ? void 0 : estimatedGas.mul(bufferGasLimitPercentage + 100).div(100)];
            }
        });
    });
}
