...
describe('useRawLogs', function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        txData = constants_2.ERC20MockInterface.encodeFunctionData('transfer(address,uint)', [to, amount]);
                        tx = {
                            to: token.address,
    ...
    function extractAddress(address) {
        var result;
        result = (0, utils_1.hexStripZeros)(address);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    (0, chai_1.expect)((0, utils_1.getAddress)(extractAddress(log.topics[1]))).to.equal((0, utils_1.getAddress)(fromAddress), 'From');
                    (0, chai_1.expect)((0, utils_1.getAddress)(extractAddress(log.topics[2]))).to.equal((0, utils_1.getAddress)(toAddress), 'To');
                    decodedData = abi_1.defaultAbiCoder.decode(['uint'], log.data);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    (0, chai_1.expect)((0, utils_1.getAddress)(extractAddress(log1.topics[1]))).to.equal((0, utils_1.getAddress)(constants_1.AddressZero), 'From');
                    (0, chai_1.expect)((0, utils_1.getAddress)(extractAddress(log1.topics[2]))).to.equal((0, utils_1.getAddress)(deployer.address), 'To');
                    decodedData1 = abi_1.defaultAbiCoder.decode(['uint'], log1.data);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    log = result.current[0];
                    (0, chai_1.expect)(log.topics[0]).to.equal(eventTopic, 'Event topic');
                    (0, chai_1.expect)((0, utils_1.getAddress)(extractAddress(log.topics[1]))).to.equal((0, utils_1.getAddress)(constants_1.AddressZero), 'From');
                    (0, chai_1.expect)((0, utils_1.getAddress)(extractAddress(log.topics[2]))).to.equal((0, utils_1.getAddress)(deployer.address), 'To');
                    decodedData = abi_1.defaultAbiCoder.decode(['uint'], log.data);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    (0, chai_1.expect)(log.topics[0]).to.equal(eventTopic, 'Event topic');
                    (0, chai_1.expect)((0, utils_1.getAddress)(extractAddress(log.topics[1]))).to.equal((0, utils_1.getAddress)(constants_1.AddressZero), 'From');
                    (0, chai_1.expect)((0, utils_1.getAddress)(extractAddress(log.topics[2]))).to.equal((0, utils_1.getAddress)(secondDeployer.address), 'To');
                    decodedData = abi_1.defaultAbiCoder.decode(['uint'], log.data);
