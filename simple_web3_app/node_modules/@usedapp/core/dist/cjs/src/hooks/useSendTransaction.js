...
function useSendTransaction(options) {
    ...
    var _c = (0, src_1.useConfig)().bufferGasLimitPercentage, bufferGasLimitPercentage = _c === void 0 ? 0 : _c;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, usePromiseTransaction_1.estimateGasLimit)(transactionRequest, signer, bufferGasLimitPercentage)];
                case 1:
                    gasLimit = _a.sent();
                    return [4 /*yield*/, promiseTransaction(signer.sendTransaction(__assign(__assign({}, transactionRequest), { gasLimit: gasLimit })))];
                case 2:
                    _a.sent();
                    _a.label = 3;
